local function config()
  ...
  vim.keymap.set("n", "<leader>sh", "<CMD>FocusSplitLeft<CR>", { noremap = true, silent = true, desc = "Split Left" })
  vim.keymap.set("n", "<leader>sj", "<CMD>FocusSplitDown<CR>", { noremap = true, silent = true, desc = "Split Down" })
  vim.keymap.set("n", "<leader>sk", "<CMD>FocusSplitUp<CR>", { noremap = true, silent = true, desc = "Split Up" })
  vim.keymap.set("n", "<leader>sl", "<CMD>FocusSplitRight<CR>", { noremap = true, silent = true, desc = "Split Right" })
