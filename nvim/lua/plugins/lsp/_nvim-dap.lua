local function config()
  ...
  vim.api.nvim_set_keymap("n", "<leader>lp", "<CMD>lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>", {silent = true, noremap = true})
  vim.api.nvim_set_keymap("n", "<leader>dr", "<CMD>lua require'dap'.repl.open()<CR>", {silent = true, noremap = true})
  vim.api.nvim_set_keymap("n", "<leader>dl", "<CMD>lua require'dap'.run_last()<CR>", {silent = true, noremap = true})

  dapgo.setup()

  vim.api.nvim_set_keymap("n", "<leader>y", "<CMD>lua require'dap-go'.debug_test()<CR>", {silent = true, noremap = true})
